...
import {createProduct,listCategory} from '../../../../api/admin';
                                        ...
                                        <div className="col-xl-5">
                                            <div className="add-product">
                                                <div className="row">
                                                    ...
                                                    <img src={this.state.Pic} alt="" className="img-fluid image_zoom_1 blur-up lazyloaded" />
                                            ...
                                            <AvForm className="needs-validation add-product-form" onValidSubmit={this.handleValidSubmit} onInvalidSubmit={this.handleInvalidSubmit}>
                                                <div className="form form-label-center">
                                                    <div className="form-group mb-3 row">
                                                        ...
                                                        <div className="col-xl-8 col-sm-7">
                                                            <AvField className="form-control"  id="validationCustom01" type="text" name="Title" onChange={this.handleChange.bind(this)} required />
                                                        </div>
                                                    ...
                                                    <div className="form-group mb-3 row">
                                                        ...
                                                        <div className="col-xl-8 col-sm-7">
                                                            <AvField className="form-control mb-0" name="price" id="validationCustom02" type="number"  name="Price" onChange={this.handleChange.bind(this)} required />
                                                        </div>
                                                        <div className="valid-feedback">Looks good!</div>
                                                    </div>
                                                    <div className="form-group mb-3 row">
                                                        ...
                                                        <div className="col-xl-8 col-sm-7">
                                                            <AvField className="form-control mb-0"  id="validationCustom03" type="number"  name="DiscountPercentage" onChange={this.handleChange.bind(this)}  required />
                                                        </div>
                                                        <div className="valid-feedback">Looks good!</div>
                                                    </div>
                                                </div>
                                                <div className="form">
                                                    <div className="form-group row">
                                                        ...
                                                        <div className="col-xl-8 col-sm-7">
                                                            <select className="form-control digits" id="exampleFormControlSelect1" name="CategoryId" onChange={this.handleChange.bind(this)}>
