                                        ...
                                        {this.props.brands.map((brand, index) => {
                                            return (
                                                <div className="custom-control custom-checkbox collection-filter-checkbox" key={index}>
                                                    ...
                                                    <input type="checkbox" onClick={(e) => this.clickBrandHendle(e,filteredBrands)} value={brand} defaultChecked={filteredBrands.includes(brand)? true : false}  className="custom-control-input col-xl-3" id={brand} />
                                                    
                                                    <label className="custom-control-label col-xl-2"
...
const mapStateToProps = (state, ownProps) => ({
    brands: getBrands(ownProps.products),
    prices: getMinMaxPrice(ownProps.products),
