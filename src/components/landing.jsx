                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="feature text-center">
                                    <div>
                                        <h5 className="title-landing">Reasones to Buy OrganicUs</h5>
                                        <p className="pb-3">OrganicUs HTML template is an apparently simple but highly
                        ...
                        <div className="row feature_row">
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">OrganicUs is a clean and morfern responsive template.it will perfectly suit for any type of online store</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">OrganicUs has powerful backend admin panel to manage products, sales, discount coupons, orders, user, vendor and much more.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">OrganicUs comes with 4 email template which include two order success template & two email template</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">OrganicUs provides multiple portfolio pages which includes 3 grid view & 4 masonary view.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Design your website LTR or RTL , OrganicUs supports multi-languages so its easy to design website on any layout such as arabic , urdu..</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4 offset-md-1 text-center center-part">
                                ...
                                <p className="pb-3">OrganicUs come with 4+ email template which include two order
