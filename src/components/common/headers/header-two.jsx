                                        ...
                                        <div>
                                            <div className="icon-nav">
                                                <ul>
                                                    ...
                                                    <li className="onhover-div mobile-setting">
                                                        ...
                                                        <div className="show-div setting">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href={null} onClick={() => this.changeLanguage('tr')}>Turkish</a> </li>
                                                            </ul>
                                                            <h6>currency</h6>
                                                            <ul className="list-inline">
                                                                <li><a href={null} onClick={() => this.props.changeCurrency('₺')}>turkish lira</a></li>
                                                    ...
                                                    { (isAuthenticated() && (
                                                        <Fragment>
                                                         <li className="mobile-wishlist"><a href={`${process.env.PUBLIC_URL}/favorite`}><img src={`${process.env.PUBLIC_URL}/assets/images/icon/like.png`} className="img-fluid" alt="" /></a></li>
                                                        <CartContainer/>
                                                        </Fragment>
                                                    ))}
                                                </ul>
