...
import CanvasJSReact from '../../assets/admin/canvas/canvasjs.react';
import {GetEarning,GetSold} from '../../api/admin';
    ...
    componentDidMount(){
        ...
        .then(data => {
            if(data.err){ 
                ...
                console.log(data)
                this.setState({
                    totalEarning: data[0].TotalEarning
                });
                
                console.log(this.state.totalEarning)
            }
        })
        GetSold(user._id,token)
        .then(data => {
            if(data.err){ 
            }else{
                console.log(data)
                this.setState({
                    totalSold: data[0].TotalQuantity
                });
                                ...
                                <div className="bg-warning card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Earnings</span>
                                            <h3 className="mb-0">$ <CountUp className="counter" end={this.state.totalEarning} /></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="bg-secondary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Products</span>
                                            <h3 className="mb-0"><CountUp className="counter" end={this.state.totalSold} /><small>sold</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
